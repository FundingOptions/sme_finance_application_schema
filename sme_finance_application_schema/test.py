...
SME_CONTACT = {"applicant_surname": "dd", "phone_number": "07445387241", "sme_name": "ddsaasd", "email": "nestor.arocha@fundingoptions.com"}
...
class TestTranslations(TestCase):
 ...
 {'applicant': {'first_name': '', 'surname': ''}, 'finance_need': {}, 'requesting_entity': {'name': 'ddsaasd', 'legal_status': 'limited_company'}})
